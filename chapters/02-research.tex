...
\begin{itemize}
  ...
  \glslink{gls-eclipse-rcp}{Eclipse RCP}/\gls{OSGi}
...
jednoduchou knihovnu, která umožňuje pomocí \gls{GUI} generovat licenční klíče,
...
\gls{GUI} pro generování licenčních souborů a runtime knihovny pro ověřování
...
% - v podstate jen podepsani licencnich udaju + \gls{GUI}
% - cena = $35
